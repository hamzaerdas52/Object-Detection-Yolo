...
img = cv2.imread("D:/01_Programlama/Yolo-Tez/darknet/model_data/images/777.jpg")
...
############ END OF OPERATION 3 ###########
    ...
    cv2.putText(img, label, (start_x, start_y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,0), 1)
